// NDVI formula and classification, mirrored from server/satellite/indices/ndvi.ts (docs/SATELLITE_MODULE.md
// §2). Duplicated rather than imported: server/ and src/ are separate TS projects (different
// module resolution, server/ isn't in tsconfig.app.json's `include`) — this is a stable, tiny
// pure function unlikely to diverge.
